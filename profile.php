        ...
        <table border="1" width="1200px" height="700px" align="center">
            ...
            <tr height="50px" style="background-color:green;">
                <td align="center" style="word-spacing: 4em;">
                    ...
                    <a href="https://www.instagram.com/sofiyandri05/" style="text-decoration: none; color: white;"><i>Instagram</i></a>
            ...
            <tr height="450px" style="background-color: green;">
                <td valign="top">
                    ...
                    <table border="1" width="700px" height="200px" style="margin-top: 30px; background-color: white">
                        <tr>
                             <td><img src="img/sopian.png" alt="sopian" width="310px"></td>
                             <td style="width: 400px;">
                             <h3 style="margin-left: 150px;">PROFILE</h3>
                             <hr>
                             <p>NAMA: SOFIANDRI AHMAD YURKHAIDI</p>
                             <p>KELAS: XI-RPL2</p>
                             <p>SEKOLAH: SMK NEEGERI 4 KOTA BOGOR</p>
                             <p>NISN: 0048152224</p>
                            </td>
                        </tr>
                    </table>
